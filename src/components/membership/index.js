...
const stripePromise = loadStripe(
  "pk_test_51QvYrZERQuYOevPAKcWmczqe3gMKp8NgTvXusIzXL8dG6g35EUcZw88Lxh0rDbMEPkMm0wDolqsEH5KGJJqyfUrX00mm1q2dk3"
);
function Membership({ profileInfo }) {
  ...
  async function handlePayment(getCurrentPlan) {
    ...
    // console.log("price_id", extractPriceId);
  }
    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className="py-20 pb-24 pt-6">
        <div className="container mx-auto p-0 space-y-8">
          <div className="g>rid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-3">
